...
btnOne.onclick = function () {
  ...
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/36.png')";
};

btnTwo.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/37.png')";
};

btnThree.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/38.png')";
};

btnFour.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/39.png')";
};

btnFive.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/40.png')";
};
