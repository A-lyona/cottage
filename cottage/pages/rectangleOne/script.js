...
btnOne.onclick = function () {
  ...
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/21.png')";
};

btnTwo.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/22.png')";
};

btnThree.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/23.png')";
};

btnFour.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/24.png')";
};

btnFive.onclick = function () {
  //открытие модального окна
  openModal();
  modalContent.style.backgroundImage = "url('../../assets/25.png')";
};
